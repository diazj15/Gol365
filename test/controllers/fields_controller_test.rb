...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { capacity: @field.capacity, city: @field.city, country: @field.country, name: @field.name }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { capacity: @field.capacity, city: @field.city, country: @field.country, name: @field.name }
    assert_redirected_to field_path(assigns(:field))
  end
