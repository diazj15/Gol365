...
class StadiaControllerTest < ActionController::TestCase
  ...
  test "should create stadium" do
    assert_difference('Stadium.count') do
      post :create, stadium: { capacity: @stadium.capacity, city: @stadium.city, country: @stadium.country, name: @stadium.name }
    end
  ...
  test "should update stadium" do
    patch :update, id: @stadium, stadium: { capacity: @stadium.capacity, city: @stadium.city, country: @stadium.country, name: @stadium.name }
    assert_redirected_to stadium_path(assigns(:stadium))
  end
